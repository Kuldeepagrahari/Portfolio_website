...
const Home = () => {
  return (
    <div name="home" className='home'>
      ...
      <Link to="https://drive.google.com/file/d/1O20NVFb4hVhK--jURKGAUjcQXE9T-PO3/view?usp=sharing">  <button style={{position:"fixed", zIndex:"1000", top:"20vh", right:"8vw",width:"100px", height:"100px"}}><RiDownloadCloud2Line style={{fontSize:"25px"}} /> Resume</button></Link>
