...
export default function RequestFlow() {
  ...
  const getTagColor = (tag) => {
    return tag === "Mandatory" ? colors.badge.mandatory : colors.badge.optional;
  };

  return (
    <div style={{ padding: '4px 0', fontFamily: "'Space Mono', 'Courier New', monospace" }}>
      <p style={{
        fontSize: '12px',
        color: colors.muted,
        lineHeight: '1.6',
          ...
          >
            <div
              style={{
                ...
                gap: '10px',
                padding: '10px 14px',
                border: `1px solid ${openIdx === i ? colors.borderLight : colors.border}`,
                borderRadius: '8px',
                color: colors.text,
                width: '100%',
                fontSize: '12px',
                transition: 'all 0.18s ease',
                background: openIdx === i ? colors.bgHover : colors.bg3,
                cursor: 'pointer',
              }}
              onClick={() => setOpenIdx(openIdx === i ? null : i)}
            >
              ...
              <span style={{
                ...
                fontWeight: 'bold',
                flexShrink: 0,
                background: getTagColor(step.tag),
              }}>
                {step.tag}
              </span>
              <span style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <span style={{
            ...
            flexShrink: 0,
            background: colors.badge.mandatory,
          }} />
        ...
        <div style={{
          ...
          <span style={{
            ...
            display: 'inline-block',
            flexShrink: 0,
            background: colors.badge.optional,
          }} />
          Optional — depends on architecture
        </div>
      </div>
    </div>
  );
